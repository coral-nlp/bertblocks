...
from polybert.modeling.packing import doc_mask, index_first_axis, index_put_first_axis, pack_seq, unpack_seq
...
class TestDocMask:
    """Test the document masking."""

    def test_docmask(self) -> None:
        """Test that docmask works correctly."""
        cu_seqlens = torch.Tensor([128, 256, 384, 512])
        mask = doc_mask(cu_seqlens)
